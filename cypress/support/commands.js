...
Cypress.Commands.add('Step1_One_day_Event', (event_name,event_organizer,date,start_time,end_time) => { 
    ...
    //click on date
    cy.xpath("/html/body/div[2]/div[3]/div/div/div[2]/div/div[4]/div[6]/button/span[1]/p").click()
    //click on clock icon
    ...
    //click on start time (hour)
    cy.xpath("/html/body/div[2]/div[3]/div/div[1]/div/div[2]/div/div/span[4]").click({force: true})
    //click on start time (second)
    cy.xpath("/html/body/div[2]/div[3]/div/div[1]/div/div[2]/div/div/span[6]").click({force: true})
    //click on end time (hour)
    ...
    cy.get(".jss25 > .MuiButton-contained > .MuiButton-label").click({force: true}) 
})
...
Cypress.Commands.add('Step2_Online_Event', (event_location) => { 
    cy.title().should('eq','PhoenixDAO Events Marketplace - Buy Tickets to Events in PHNX.')
    cy.contains('Create Event').should('be.visible')
    cy.contains('Event Details').should('be.visible')
